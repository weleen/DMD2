...
OUTPUT_DIR=./log/robust_training/laionv2_6.5_plus_sd_robust_training_distill_1node
...
accelerate launch --mixed_precision="bf16" --multi_gpu --num-processes $NUM_GPUS main/train_sd_robust.py \
