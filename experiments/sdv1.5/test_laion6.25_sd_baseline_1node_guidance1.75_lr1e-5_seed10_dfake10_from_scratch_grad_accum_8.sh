...
python main/test_folder_sd.py   --folder $CHECKPOINT_PATH/laion6.25_sd_baseline_1node_guidance1.75_lr1e-5_seed10_dfake10_from_scratch_gradient_accum_8/cache/time_1719502059_seed10 \
    --wandb_name test_laion6.25_sd_baseline_1node_guidance1.75_lr1e-5_seed10_dfake10_from_scratch_grad_accum_8 \
