# Adapt from https://github.com/alibaba/animate-anything
...
from third_party.animate_anything.utils.dataset import get_train_dataset, extend_datasets
from third_party.animate_anything.models.pipeline import MaskStableVideoDiffusionPipeline
...
def main(
    ...
    *_, config = inspect.getargvalues(inspect.currentframe())
    ...
    if accelerator.is_main_process:
        accelerator.init_trackers("svd-fine-tune")
