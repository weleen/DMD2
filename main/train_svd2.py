# Adapt from https://github.com/pixeli99/SVD_Xtend/blob/main/train_svd.py
...
def parse_args():
    parser = argparse.ArgumentParser(
        description="Script to finetune Stable Video Diffusion, support DiffusionGAN."
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--use_sm3_optimizer",
        action="store_true",
        help="Whether or not to use SM3 optimizer. Refer to https://github.com/google-research/google-research/blob/master/sm3/README.md and https://github.com/Enealor/PyTorch-SM3",
    )
    parser.add_argument(
        "--allow_tf32",
        action="store_true",
    ...
    parser.add_argument(
        ...
        type=int,
        default=4,
        help="The number of time steps for generator.",
    )
    parser.add_argument(
        "--T_discriminator",
        type=int,
        default=1000,
        help="The number of time steps for discriminator.",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=str,
        default="unet-encoder",
        help="The discriminator network to use."
    )
    parser.add_argument(
        "--discriminator_projected_condition",
        type=str,
        default="image+schedule",
        help="The condition projected for training the discriminator."
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--adjust_constant_reconstruction",
        type=float,
        default=0.1,
        help="The constant to adjust the reconstruction loss.",
    )
    parser.add_argument(
        "--P_mean",
        type=float,
    ...
    parser.add_argument(
        ...
        type=float,
        default=-1.0,
        help="The variance of the prior distribution.",
    )
